...
public class CitrineSanctumScreen extends PEContainerScreen<CitrineSanctumChestContainer> {

	private static final ResourceLocation texture = PECore.rl("textures/gui/alchchest.png");

	public CitrineSanctumScreen(CitrineSanctumChestContainer container, Inventory invPlayer, Component title) {
